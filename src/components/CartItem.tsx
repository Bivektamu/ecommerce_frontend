    ...
    return (
        <div key={cartItem.id} className="flex items-center justify-between gap-x-12 gap-y-8 mb-8">
            <div className="flex items-center gap-6">
                ...
                <div>
                    <h3 className="font-semibold mb-2">{product ? product.title : <TextLoader col='1' cssClass='' />}</h3>
                    {!product ? <TextLoader col='1' cssClass='' />
                        :
            ...
            <div className='flex items-center gap-4'>
                ...
                <p className='font-semibold mr-4'>{!product ? <TextLoader col='1' cssClass='' /> : '$' + cartItem.price}</p>
